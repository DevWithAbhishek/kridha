            ...
            <div className="max-w-page mx-auto px-page-x md:px-page-x-md">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    {steps.map((step, index) => (
                        <div key={index} className="bg-[var(--color-surface)] rounded-card shadow-card p-card border border-[var(--color-border)] hover:shadow-card-hover transition-all duration-slow">
